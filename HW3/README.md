...
This folder contains solutions for Homework 3 for ENBC312.

## Problems

* **hw3q1.cpp** – Accessing array elements using pointers
* **hw3q2.cpp** – Computing the sum of two integers using pointers
